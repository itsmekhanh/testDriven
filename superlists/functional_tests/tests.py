...
class NewVisitorTest(LiveServerTestCase):
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        # Edith heard about about a cool new online to-do app. She goes to check out the homepage
        ...
        # We use a new browser session to make sure no information of Edith's
